        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Edit Dream :{{ $wzt->number }}</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form id="quickForm">
              <div class="card-body">
                  ...
                  <!--input-->
                    ...
                    <div class="row " >
                      ...
                      <div class="col-md-4">
                         ...
                         <input name="number" class="form-control" id="" placeholder="Enter number" value="{{ $wzt->number }}" required autocomplete="number" autofocus >
                ...
                <div class="form-group">
                  ...
                  <div class="row  mb-2 justify-content-between" >
                    <div class="col-md-6">
                      <input  name="cn" class="form-control "  value="{{ $wzt->cn }}"  autofocus>
                      <span class="text-danger">@error('cn') {{ $errors->first('cn') }} @enderror</span>
                    </div>

                    <div class="col-md-6">
                      <input  name="en" class="form-control " value="{{ $wzt->en }}"  autofocus>
                ...
                <div class="form-group">
                  ...
                  <div class="row  mb-2 justify-content-between" >
                    <div class="col-md-6">
                      <input  name="my" class="form-control "  value="{{ $wzt->my }}"  autofocus>
                      <span class="text-danger">@error('my') {{ $errors->first('my') }} @enderror</span>
                    </div>

                    <div class="col-md-6">
                      <input  name="th" class="form-control " value="{{ $wzt->th }}"  autofocus>
                    ...
                    <div class="form-group">
                      ...
                      <div class="row " >
                        <div class="col-md-12">
                         <div class="drop-zone">
                          <img class="OldImage" src="/public/images/{{ ($wzt->image) }}" height="100px" width="100px">
